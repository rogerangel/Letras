    ...
    <div className="relative">
      ...
      <AnimatePresence>
        <motion.div
          ...
          className="absolute top-0 h-full flex flex-col justify-around md:justify-evenly items-center bg-stone-900 shadow-2xl px-3 bg-opacity-70 md:bg-opacity-70"
