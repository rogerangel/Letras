                ...
                project.body["sections"].map((section) => (
                  <div key={section.id}>
                    ...
                    {section.text.map((text, index) => (
                      <p
                        key={index}
                        className="px-5 py-2 text-left font-sans text-base font-normal leading-7 tracking-wider text-gray-900 lg:text-justify lg:tracking-wide"
                      >
                        <MarkedText
                          text={text}
                    ...
                    {section.description &&
                      section.description.text.map((description, index) => (
                        <p
                          key={index}
                          className="text-md px-5 pb-4 pt-0.5 text-center italic leading-7 text-gray-700"
                        >
                          {description}
                        </p>
                      ))}
