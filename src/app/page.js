...
export default function Home() {
  return (
    <main className="relative">
      <Hero />
      <div className="bg-stone-200 w-full py-14 gap-10 flex flex-col justify-center items-center text-center">
        ...
        <p className="text-2xl w-1/2 font-medium text-neutral-700">
      ...
      <div className="bg-gradient-to-b from-stone-200 to-stone-300 w-full h-[600px] flex flex-row gap-4 justify-around items-center from-10% to-90%">
        <Image
          src={kid_2}
          alt="kid_2"
          className="object-cover w-[33%] h-[80%] rounded-3xl"
        />
        <div className="flex w-1/2 flex-col gap-16">
          <h1 className="text-4xl font-bold text-indigo-900">What we do!</h1>
          <p className="text-2xl tracking-wider leading-normal font-medium text-neutral-800">
      ...
      <div className="via-stone-200 to-stone-300 from-stone-300 bg-gradient-to-b from-60% via-30% to-10% w-full flex flex-col h-[1500px]">
        <ScrollCard className="h-full w-full rounded-3xl bg-teal-600 shadow-md">
          <div className="sticky top-0 flex flex-col pt-64 px-72 pb-52">
            <div className="gap-5 inline-flex text-2xl text-white">
              <FaBookOpenReader />
      ...
      <div className="via-stone-300 to-stone-200 from-stone-300 bg-gradient-to-b from-8% via-35% to-90% w-full py-10 gap-10 flex flex-col justify-center items-center text-center h-[600px]">
        ...
        <h3 className="mt-24 text-4xl font-bold text-indigo-900">
          Our Ultimate Approach
        </h3>
        <div className="mt-10 flex flex-col flex-wrap content-start md:gap-4 lg:gap-10 md:flex-row">
